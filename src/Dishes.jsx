    ...
    return (
        <>
            ...
            <div className="flex justify-end w-full">
                <button style={{ marginLeft: "85.5%" }} onClick={handleNewDishe} className="ml-20, bg-slate-300 hover:bg-slate-400 transition px-6 py-4 rounded-lg shadow flex flex-col items-center">
                    <span className="text-xl font-semibold mb-2">create new dish</span>
                    <span className="text-3xl">➕🍽️</span>
                </button>
            </div>
            <DishesList dishe={dishe} setDishe={handleDishe} handleDeleteDishe={handleDeleteDishe} handleDetailDishe={handleDetailDishe} handleEditDishe={handleEditDishe} />
