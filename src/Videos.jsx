    ...
    return (
        <>
            ...
            <div className="flex justify-end w-full">
                <button style={{ marginLeft: "85.5%" }} onClick={handleNewVideo} className="ml-20, bg-slate-300 hover:bg-slate-400 transition px-6 py-4 rounded-lg shadow flex flex-col items-center">
                    <span className="text-xl font-semibold mb-2">create new video</span>
                    <span className="text-3xl">➕🎬</span>
                </button>
            </div>
            <VideosList video={video} setVideo={handleVideo} handleDeleteVideo={handleDeleteVideo} handleEditVideo={handleEditVideo} />
