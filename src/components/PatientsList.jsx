...
export const PatientsList = ({ patient, setPatient, handleDeletePatient, handlePatientProgress }) => {
  return (
      ...
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
        <div className="p-6">
          <div className="bg-[#c4d2d0] p-4 rounded-lg shadow-inner">
            <h4 className="text-xl font-semibold text-gray-800 mb-4">Gestió pacients</h4>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 bg-white rounded-md shadow">
                    ...
                    <tbody className="divide-y divide-gray-200">
                        <Patient patient={patient} setPatient={setPatient} handleDeletePatient={handleDeletePatient} handlePatientProgress={handlePatientProgress} />
                    </tbody>
                </table>
              </div>
            ) : (
