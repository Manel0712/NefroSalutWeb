    ...
    return quiz.map((quizInformation, i) => (
      <tr key={i} className="hover:bg-gray-50">
        ...
        <td className="px-4 py-2">
          ...
          <button
            onClick={() => handleEditQuiz(quizInformation.id, quizInformation.pregunta, quizInformation.option1, quizInformation.option2, quizInformation.option3, quizInformation.correctOption, quizInformation.categoria)}
            className="text-blue-600 hover:underline"
          >
            Editar
          </button>
