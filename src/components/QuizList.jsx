...
export const QuizList = ({ quiz, setQuiz, handleDeleteQuiz, handleEditQuiz }) => {
  return (
      ...
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
        <div className="p-6">
          <div className="bg-[#c4d2d0] p-4 rounded-lg shadow-inner">
            <h4 className="text-xl font-semibold text-gray-800 mb-4">Gestió quizzes</h4>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 bg-white rounded-md shadow">
                    ...
                    <tbody className="divide-y divide-gray-200">
                        <Quiz quiz={quiz} setQuiz={setQuiz} handleDeleteQuiz={handleDeleteQuiz} handleEditQuiz={handleEditQuiz} />
                    </tbody>
                </table>
              </div>
            ) : (
